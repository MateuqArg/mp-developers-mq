...
<div id="slider_input1" class="container" style="display: none;">
	<form action="{{ route('slider.admin') }}" method="POST" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-7">
				<input type="text" name="number" value="1" hidden>
				<input type="file" name="image" class="text-center form-control">		
			</div>
			<div class="col-md-3">
...
<div id="slider_input2" class="container" style="display: none;">
...
<div id="slider_input3" class="container" style="display: none;">
	<form action="{{ url('/slider') }}">
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-7">
...
<script type="text/javascript">
	$(document).ready(function() {
  	...
  	function slider(id) {
  		console.log(id);
  		var slider_input = document.getElementById("slider_input"+id);
  		var slider_input1 = document.getElementById("slider_input1");
  		var slider_input2 = document.getElementById("slider_input2");
  		var slider_input3 = document.getElementById("slider_input3");

  		if (slider_input.style.display === "none") {
  			slider_input1.style.display = "none";
    		slider_input2.style.display = "none";
    		slider_input3.style.display = "none";
    		slider_input.style.display = "block";
    		console.log('Block');
  		} else {
    		slider_input.style.display = "none";
    		console.log('None');
  		}
	}
